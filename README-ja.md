# xCockpit - Web3 IoTコントロールダッシュボード

[English Ver README is here](README-ja.md) 

## 概要

xCockpitは、ブロックチェーン決済を活用した革新的なIoTデバイス制御プラットフォームです。ESP32ベースのガチャマシンを、Base Network上のUSDC決済を通じてリモート制御できます。X402プロトコル（HTTP 402 Payment Required）を実装し、マイクロペイメントによるデバイス制御を実現しています。
