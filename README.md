# xCockpit - Web3 IoT Control Dashboard

[日本語版 README はこちら](README-ja.md) 

## Overview

xCockpit is an innovative IoT device control platform powered by blockchain payments. It enables remote control of ESP32-based gacha machines through USDC payments on Base Network. Implementing the X402 protocol (HTTP 402 Payment Required), it realizes device control through micropayments.
